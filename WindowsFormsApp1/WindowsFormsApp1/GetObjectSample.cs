...
namespace WindowsFormsApp1
{
   ...
   public static class GetObjectSample
   {
       ...
       static OssClient client = new OssClient(endpoint, accessKeyId, accessKeySecret);
        ...
        static string key = "PutObjectFromFile"; //"GetObjectSample";
       ...
       public static string GetObject(string bucketName,string key,string dirToDownload,string fileName)
       {
            string msg = "";
            try
           {
